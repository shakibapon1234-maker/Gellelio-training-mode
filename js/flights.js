(function (global) {
  ...
  function search({ origin, destination, carrier, date }) {
    ...
    if (origin === "DAC" && destination === "SIN") {
      ...
      results = carriers.map((flight, index) => ({
        line: index + 1, carrier: flight[0], number: flight[1], date: (typeof reqDate !== "undefined" && reqDate) || "15NOV", freq: (typeof reqFreq !== "undefined" && reqFreq) || "15",
        origin: index === 1 || index === 3 ? "DAC" : "DAC", destination: index === 2 || index === 6 ? "KUL" : "BKK",
        depart: ["0200", "1340", "1300", "2105", "0825", "1620", "0050", "0910", "2355", "0815", "1230", "2105", "0825", "1520", "1730"][index],
        arrive: ["0530", "1710", "1850", "2210", "1420", "1740", "0650", "1020", "0600", "0935", "1840", "2210", "1420", "1545", "1900"][index],
        equip: flight[2], termOrig: "1", termDest: "1", airline_full: "TRAINING CARRIER",
        classes: { C: 9, D: 9, J: 9, Z: 9, Y: 9, B: 9, M: 9, H: 9, Q: 9, T: 9, K: 9, S: 9, V: 9, W: 9, L: 9, G: 9, R: 9, U: 9 }, rows: ["T9 K9 S9 V9 W9 LC", "H9 Q9 T9 K9 S9 V9 W9"], notes: []
      }));
    ...
    if (!results.length && origin === "DAC" && destination) {
      results = [
        ["BG", "147", "788", "0130", "0520"], ["BS", "315", "333", "0825", "1420"],
        ["TG", "322", "333", "1340", "1710"], ["QR", "639", "77W", "0400", "0650"],
